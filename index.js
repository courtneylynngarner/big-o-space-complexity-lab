...
// ANSWER: Both functions are asking us to look at the letters once and return the function. There is only one operation, so nothing is working in a quadratic space.
...
class SubtractCache {
  ...
  subtractTwo(num1, num2) {
    let propertay = `${num1}${num2}`;
    if (this.cache.hasOwnProperty(propertay)) {
      return this.cache[propertay];
    }
    let answer = num1 - num2;
    this.cache[propertay] = answer;
    return answer;
  }
}
/*
...
console.log(mySub.subtractTwo(10, 4));
console.log(mySub.subtractTwo(10, 4));
console.log(mySub.subtractTwo(10, 4));
console.log(mySub.subtractTwo(10, 4));
